...
public class OrderController {
                                ...
                                @Content(
                                        ...
                                        examples =
                                                @ExampleObject(
                                                        value =
                                                                ErrorResponseExamples
                                                                        .ORDER_AUDIT_ENTRIES_NOT_FOUND)))
            })
    ResponseEntity<PagedResponse<OrderAuditEntryResponse>> getAudit(
            @PathVariable @Positive @Parameter(description = "The order ID", example = "2")
                    Long orderId,
            @ParameterObject
    ...
    ResponseEntity<OrderAuditEntryResponse> getAuditByVersion(
            ...
            @PathVariable
                    @Positive
                    @Parameter(description = "The audit entry version", example = "3")
                    Long version) {
