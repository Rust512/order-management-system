...
public class ProductController {
    ...
    @ApiResponse(
            ...
            content =
                    @Content(
                            ...
                            examples =
                                    @ExampleObject(
                                            value = ErrorResponseExamples.PRODUCT_ALREADY_EXISTS)))
    ...
    @ApiResponse(
            ...
            content =
                    @Content(
                            ...
                            examples =
                                    @ExampleObject(
                                            value = ErrorResponseExamples.PRODUCT_NOT_FOUND)))
    ResponseEntity<ProductResponse> updateProduct(
            @PathVariable long id, @RequestBody @Valid ProductUpdateRequest updateRequest) {
    ...
    ResponseEntity<PagedResponse<ProductResponse>> getProducts(
            @RequestParam @Parameter(description = "Zero-based page index", example = "0") int page,
            @RequestParam
                    @Positive
                    @Parameter(description = "The number of items per page", example = "5")
                    int size) {
    ...
    @ApiResponse(
            ...
            content =
                    @Content(
                            ...
                            examples =
                                    @ExampleObject(
                                            value = ResponseExamples.GET_PRODUCT_AUDIT_ENTRIES)))
    @ApiResponse(
            responseCode = "404",
            description = "Resource not found",
            content =
                                    ...
                                    @ExampleObject(
                                            value =
                                                    ErrorResponseExamples
                                                            .PRODUCT_NOT_FOUND_FOR_AUDIT)))
    ResponseEntity<PagedResponse<ProductAuditEntryResponse>> getProductAuditEntries(
            @Positive @PathVariable @Parameter(description = "The product ID", example = "2")
                    long productId,
            @ParameterObject
    ...
    @ApiResponse(
            ...
            content =
                    @Content(
                            ...
                            examples =
                                    @ExampleObject(
                                            value = ResponseExamples.GET_PRODUCT_AUDIT_ENTRY)))
    @ApiResponse(
            responseCode = "404",
            description = "Resource not found",
            content =
                    @Content(
                            ...
                            examples =
                                    @ExampleObject(
                                            value =
                                                    ErrorResponseExamples
                                                            .PRODUCT_AUDIT_ENTRY_NOT_FOUND)))
    ResponseEntity<ProductAuditEntryResponse> getProductAuditEntry(
            @Positive @PathVariable @Parameter(description = "The product ID", example = "2")
                    long productId,
            @Positive
                    @PathVariable
                    @Parameter(description = "The product audit entry version", example = "3")
                    long version) {
