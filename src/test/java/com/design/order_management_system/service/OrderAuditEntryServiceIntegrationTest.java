...
class OrderAuditEntryServiceIntegrationTest extends DatabaseTest {
    @Autowired
    ...
    void getOrderAuditEntries_WithAdminUser_ShouldReturnOrderAuditEntries() {
        ...
        var auditLogsUri = UriComponentsBuilder.fromUriString("/v1/orders/{orderId}/audit")
                .queryParam("page", page)
                .queryParam("size", size)
                .buildAndExpand(orderId)
                .toUri();

        var auditLogResponse = restTemplate.exchange(auditLogsUri, HttpMethod.GET, auditEntryRequest, PagedResponse.class);
