    ...
    void getDraftOrder_WhenDraftOrderDoesNotExist_ShouldReturnNewDraftOrder() {
        ...
        transactionTemplate.executeWithoutResult(
                _ -> {
                    ...
                    Assertions.assertThat(newDraftOrder.getOrderStatus())
                    ...
                    var persistedOrder =
                            orderRepository.findById(newDraftOrder.getId()).orElseThrow();
                    ...
                    Assertions.assertThat(persistedOrder.getOrderStatus())
                            .isEqualTo(OrderStatus.CREATED);
                    Assertions.assertThat(persistedOrder.getUser().getId())
