...
class SecurityUtilsTest {
    ...
    @DisplayName("""
            ...
            """)
    void getPrincipalUserFromAuthentication_WhenAuthenticationNull_ShouldThrowAuthorizationServiceException() {
    ...
    @DisplayName("""
            ...
            the getPrincipalUserFromAuthentication method should throw AuthorizationServiceException
            """)
    void getPrincipalUserFromAuthentication_WhenAuthenticationPrincipalNull_ShouldThrowAuthorizationServiceException() {
        var authentication = mock(Authentication.class);
        when(authentication.getPrincipal()).thenReturn(null);
        Assertions.assertThatThrownBy(() -> SecurityUtils.getPrincipalUserFromAuthentication(authentication))
                .isInstanceOf(AuthorizationServiceException.class)
    ...
    @DisplayName("""
            ...
            the getPrincipalUserFromAuthentication method should throw AuthorizationServiceException
            """)
    void getPrincipalUserFromAuthentication_WhenAuthenticationPrincipalNotPrincipalUserInstance_ShouldThrowAuthorizationServiceException() {
        var authentication = mock(Authentication.class);
