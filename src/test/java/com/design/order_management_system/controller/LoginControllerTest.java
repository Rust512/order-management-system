...
class LoginControllerTest {
  ...
  @Test
  @DisplayName(
      value = "POST /auth/login with invalid credentials should respond with HTTP status 401")
  void login_WhenCredentialsAreInvalid_ShouldReturnStatus401() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath("$.sExceptionName").value(InvalidCredentialsException.class.getSimpleName()));
  }
}
